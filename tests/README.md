...
| `load/claude-concurrent.js` | Same Kopi Run scenario against Claude (Anthropic) — rate-limit detection | 20 |
...
> **Cost note** — 20 VUs × ~4 turns = ~80 Claude Sonnet API calls per run.
