    ...
    return (
      <main className="min-h-screen bg-[#eeede9] p-6 text-ink">
        <section className="mx-auto mt-12 max-w-2xl rounded-panel bg-white p-8 soft-edge">
          ...
          <h1 className="mt-3 font-display text-[38px]">Your attempt is immutable.</h1>
          <dl className="mt-8 grid gap-4 rounded-panel bg-cloud p-5 text-small sm:grid-cols-2">
            ...
            <div><dt className="text-muted">Status</dt><dd className="m-0 mt-1 font-medium">Pending AI processing</dd></div>
          </dl>
  ...
  return (
    <main className="min-h-screen bg-[#eeede9] p-6 text-ink">
      <section className="mx-auto mt-8 max-w-2xl rounded-panel bg-white p-8 soft-edge">
        ...
        <h1 className="mt-3 font-display text-[38px]">Submit for evaluation</h1>
        ...
        <form className="mt-7 grid gap-5" onSubmit={submit}>
          ...
          <CaseSubmissionPanel
            title={definition.submissionTitle ?? "Your submission"}
            ...
            placeholder={definition.workProductPlaceholder ?? "Paste or review the final work product you want evaluated."}
